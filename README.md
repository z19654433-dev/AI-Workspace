...
> 一个基于 **DeepSeek API** 和 **FastAPI** 的 知识库智能 Agent，具备长期记忆、多会话隔离、自主工具调用（Function Calling）能力，附带 **React 聊天界面**。
...
```bash
git clone https://github.com/z19654433-dev/Knowledge-Agent.git
cd Knowledge-Agent
```
